                    ...
                    <form action="{{ route('kegiatan.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('tipe_kegiatan') is-invalid @enderror" id="tipe_kegiatan" name="tipe_kegiatan" required>
                                ...
                                <option value="ibadah" {{ old('tipe_kegiatan') == 'ibadah' ? 'selected' : '' }}>Ibadah</option>
                                <option value="komsel" {{ old('tipe_kegiatan') == 'komsel' ? 'selected' : '' }}>Kelompok Sel</option>
                                ...
                                <option value="lainnya" {{ old('tipe_kegiatan') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                            @error('tipe_kegiatan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
