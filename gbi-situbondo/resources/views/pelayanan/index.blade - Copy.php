                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card h-100 bg-light">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title">Jadwal Pelayanan Mendatang</h5>
                                    <p class="card-text">Jadwal pelayanan yang akan datang untuk semua kegiatan ibadah.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="card h-100 bg-light">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title">Riwayat Pelayanan</h5>
                                    <p class="card-text">Catatan pelayanan yang telah dilakukan sebelumnya.</p>
                                </div>
                            </div>
                        </div>
                    </div>
